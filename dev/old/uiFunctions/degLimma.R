  ...
  tabPanel("DEGs",
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        sidebarPanel(
          ...
          fluidRow(column(4, downloadButton("donwloadDegs", "Download Results")),
            ...
            column(4, actionButton("jumpToDegsViz", "Visualize Results")),
            align = "center"
          )
        ),
        ...
        # Main Panel output
        mainPanel(
          DT::dataTableOutput("previous"), fluidRow(actionButton("clear", label = "Reselect"), align = "right"),
      ...
      tabPanel("View Results",
        ...
        # DEGs table
        fluidRow(
          column(6, DT::dataTableOutput("diff_dt")),
